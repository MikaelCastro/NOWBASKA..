        ...
        <div class="hero-body">
            <div class="container has-text-centered">
                <div class="column is-4 is-offset-4">
                    ...
                    <h3 class="title has-text-grey"><a href="https://youtube.com/canaltioficial" target="_blank">NowBaska</a></h3>
                ...
                ?>
                    <div class="box">
                        <form action="cadastrar.php" method="POST">
                            ...
                            <div class="field">
                              <button type="submit" class="button is-block is-link is-large is-fullwidth"> <a href="cadastro.php">Login</a></button>
                              
                           <p> <button type="submit" class="button is-block is-link is-large is-fullwidth">Cadastrar</button></p>
                        </form>
                    </div>
                </div>
            </div>
