        ...
        <div class="container">
          <div class="row justify-content-sm-center">
            <div class="col-sm-10 col-md-5">
              ...
              <div class="member-block-type-5 inset-lg-right-20"><img class="img-fluid mx-auto d-block" src="images/jorjeg.jpeg" width="437" height="437" alt=""/>
                <div class="member-block-body"><a class="btn btn-block btn-danger" href="Contato.php">Faça sua pergunta</a>
                  <div class="offset-top-34">
                    <ul class="list-inline list-inline-xs">
                      <li class="list-inline-item"><a class="novi-icon icon icon-xxs icon-circle icon-darkest-filled fa-facebook" href="https://www.facebook.com/jorge.fernando.1912"></a></li>
                      
                    </ul>
                  </div>
                  <address class="contact-info offset-top-20 offset-md-top-34">
                    <ul class="list-unstyled p">
                      <li><span class="novi-icon icon icon-xxs text-middle text-dark mdi mdi-phone"></span><a class="p big text-middle d-inline-block offset-top-0" href="tel:1-800-1234-567">(11)94175-9423</a></li>
                      <li><span class="novi-icon icon icon-xxs text-middle text-dark mdi mdi-email-open"></span><a class="p big text-middle d-inline-block offset-top-0 text-picton-blue" href="jorgefernando@hotmail.com">jorgefernando@hotmail.com</a></li>
                    </ul>
                  </address>
                </div>
              </div>
            ...
            <div class="col-sm-10 col-md-7 text-md-left">
              <div>
                <h1 class="text-darker">Jorge Fernando Ferreira da Silva</h1>
              </div>
              <p class="text-muted offset-top-4">Treinador de Defesa</p>
              <hr class="divider bg-red hr-md-left-0">
              <p class="offset-top-50 text-left"> Jorge Fernando é um ótimo defensor e sabe muito bem como roubar a bola de alguém com facilidade.</p>
              <div class="offset-top-30 text-center">
                <p>
                  <q class="font-italic h3 text-regular">"Defender a cesta da maneira correta é a melhor forma para se chegar a vitória"</q>
                </p>
              </div>
              <div class="offset-top-30">
                <p class="text-left">Jorge Fernando Pratica o esporte a 4 anos e joga como pivo.</p>
              </div>
                ...
                <div class="offset-top-50">
                  ...
                  <div class="progress-linear" data-to="54">
                    <div class="progress-linear-header clearfix">
                      ...
                      <div><span class="big text-ubold pull-right progress-linear-counter">92</span></div>
                    </div>
                    <div class="progress-linear-body">
                ...
                <div class="offset-top-50">
                  ...
                  <div class="progress-linear" data-to="87">
                    <div class="progress-linear-header clearfix">
                      ...
                      <div><span class="big text-ubold pull-right progress-linear-counter">73</span></div>
                    </div>
                    <div class="progress-linear-body">
                ...
                <div class="offset-top-50">
                  ...
                  <div class="progress-linear" data-to="65">
                    <div class="progress-linear-header clearfix">
                      ...
                      <div><span class="big text-ubold pull-right progress-linear-counter">78</span></div>
                    </div>
                    <div class="progress-linear-body">
