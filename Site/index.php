                ...
                <div class="swiper-slide-caption">
                  <div class="container">
                    <div class="row justify-content-xl-center">
                      <div class="col-xl-12">
                        <div class="text-extra-big font-weight-bold font-italic text-uppercase" data-caption-animate="fadeInUp" data-caption-delay="300">Encontre novas quadras</div>
                      </div>
                      <div class="col-xl-8 offset-top-10">
                        <h5 class="hidden d-sm-block text-light" data-caption-animate="fadeInUp" data-caption-delay="500">
                          Use o localizador para encontrar quadras para praticar o basquete.
 
                        </h5>
                        <div class="offset-top-20 offset-sm-top-50"><a class="btn btn-danger btn-anis-effect" href="Localizador.php" data-waypoint-to="#welcome" data-caption-animate="fadeInUp" data-caption-delay="800"><span class="btn-text">Vamos lá</span></a></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="swiper-caption swiper-parallax" data-speed="0.5" data-fade="true">
                <div class="swiper-slide-caption">
                  <div class="container">
                    <div class="row justify-content-xl-center">
                      <div class="col-xl-12">
                        <div class="text-extra-big font-weight-bold font-italic text-uppercase" data-caption-animate="fadeInUp" data-caption-delay="300">Entenda melhor nossos objetivos</div>
                      </div>
                      <div class="col-xl-8 offset-top-10">
      ...
      <section class="section-98 section-md-110 novi-background" data-preset='{"title":"Content block 1","category":"content","id":"content-block-1"}'>
        <div class="container">
          ...
          <div class="row justify-content-sm-center offset-top-66">
            <div class="col-xl-8">
              <p>Bem vindo ao NowBaska! Nós vamos te ajudar a encontrar um lugar e companheiros para praticar esse esporte tão divertido que é o basquete. Abaixo mostramos nossas três propostas:</p>
            </div>
          </div>
          <div class="row justify-content-center grid-group-lg offset-top-98">
            <div class="col-md-8 col-lg-4">
              ...
              <div class="box-icon box-icon-bordered"><span class="novi-icon icon icon-outlined icon-sm icon-dark-filled mdi mdi-account-multiple"></span>
                <h4 class="text-danger offset-top-20">Notícias</h4>
                <p>Fique por dentro das principais e mais recentes notícias do mundo do basquete.</p>
              </div>
            </div>
            <div class="col-md-8 col-lg-4">
              ...
              <div class="box-icon box-icon-bordered"><span class="novi-icon icon icon-outlined icon-xs icon-dark-filled mdi mdi-thumb-up"></span>
                <h4 class="text-danger offset-top-20">Regras e dicas do Basquete</h4>
                <p>Se você esta comeceçando a jogar agora não se preocupe, aqui você também encontra as regras e dicas básicas do basquete.</p>
              </div>
            </div>
            <div class="col-md-8 col-lg-4">
              ...
              <div class="box-icon box-icon-bordered"><span class="novi-icon icon icon-outlined icon-sm icon-dark-filled mdi mdi-dumbbell"></span>
                <h4 class="text-danger offset-top-20">Locais</h4>
                <p>Se você não sabe onde praticar o basquete, temos a aba de localização, para você achar quadras dísponiveis.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section data-preset='{"title":"Carousel 1","category":"content, carousel","reload":true,"id":"carousel-1"}'>
        <div class="owl-carousel owl-carousel-default d-lg-none-owl-dots veil-owl-nav d-lg-owl-nav" data-items="1" data-sm-items="2" data-lg-items="3" data-xl-items="4" data-nav="true" data-dots="true" data-nav-class="[&quot;owl-prev mdi mdi-chevron-left&quot;, &quot;owl-next mdi mdi-chevron-right&quot;]">
          <div>
            ...
            <figure class="thumbnail-terry"><a href="https://www.youtube.com/channel/UC6aaeX2BVCnSZE7AH7Mzk_w"><img width="480" height="480" src="images/home-01-480x480.jpg" alt=""/></a>
              <figcaption>
                <div>
                  <h4 class="thumbnail-terry-title">Arremessos</h4>
                </div>
          ...
          <div>
            ...
            <figure class="thumbnail-terry"><a href="https://www.youtube.com/channel/UC6aaeX2BVCnSZE7AH7Mzk_w"><img width="480" height="480" src="images/dibre.jpg" alt=""/></a>
              <figcaption>
                <div>
                  <h4 class="thumbnail-terry-title">Dribles</h4>
                </div>
                <p class="thumbnail-terry-desc offset-top-0"></p><a class="btn offset-top-10 offset-lg-top-0 btn-danger" href="https://www.youtube.com/channel/UC6aaeX2BVCnSZE7AH7Mzk_w">Vamos lá</a>
              </figcaption>
            </figure>
          ...
          <div>
            ...
            <figure class="thumbnail-terry"><a href="https://www.youtube.com/channel/UC6aaeX2BVCnSZE7AH7Mzk_w"><img width="480" height="480" src="images/passe.jpg" alt=""/></a>
              <figcaption>
                <div>
          ...
          <div>
            ...
            <figure class="thumbnail-terry"><a href="https://www.youtube.com/channel/UC6aaeX2BVCnSZE7AH7Mzk_w"><img width="480" height="480" src="images/defesa.jpg" alt=""/></a>
              <figcaption>
                <div>
            ...
            <div class="col-md-10 col-xl-12">
              <div class="row">
                <div class="col-md-6 col-xl-3">
                  ...
                  <div class="box-member"><img class="img-fluid" src="images/mikael.jpg" alt=""/>
                    <h5 class="font-weight-bold offset-top-20"><a href="TreinadorM.php">Mikael de Castro</a> <small class="text-danger">Arremessos</small>
                    </h5>
                    <div class="box-member-caption">
                      <div class="box-member-caption-inner">
                        <ul class="list-inline list-inline-xs">
                          <li class="list-inline-item"><a class="novi-icon icon fa fa-facebook icon-xs icon-circle icon-darkest-filled" href="https://www.facebook.com/mikael.castro.35/"></a></li>
                          
                        </ul>
                      </div>
                    </div>
                  </div>
                  <p class="offset-xl-top-0 text-muted">Mikael mostrara como sempre acertar uma cesta nao importa o local da quadra onde você estiver.</p>
                </div>
                <div class="col-md-6 col-xl-3 offset-top-66 offset-md-top-0 offset-xl-top-0">
                  
                  <div class="box-member"><img class="img-fluid" src="images/grava.jpg" alt=""/>
                    <h5 class="font-weight-bold offset-top-20"><a href="TreinadorG.php">Gustavo Grava</a> <small class="text-danger">Drible</small>
                    </h5>
                    <div class="box-member-caption">
                      <div class="box-member-caption-inner">
                        <ul class="list-inline list-inline-xs">
                          <li class="list-inline-item"><a class="novi-icon icon fa fa-facebook icon-xs icon-circle icon-darkest-filled" href="https://www.facebook.com/profile.php?id=100018280783672"></a></li>
                          
                        </ul>
                      </div>
                    </div>
                  </div>
                  <p class="offset-xl-top-0 text-muted">Gustavo ensina a como possuir um ótimo controle de bola e como efetuar diersos dribles.</p>
                </div>
                <div class="col-md-6 col-xl-3 offset-top-66 offset-xl-top-0">
                  
                  <div class="box-member"><img class="img-fluid" src="images/jorge.jpg" alt=""/>
                    <h5 class="font-weight-bold offset-top-20"><a href="TreinadorJ.php">Jorge Fernando</a> <small class="text-danger">Defesa</small>
                    </h5>
                    <div class="box-member-caption">
                      <div class="box-member-caption-inner">
                        <ul class="list-inline list-inline-xs">
                          <li class="list-inline-item"><a class="novi-icon icon fa fa-facebook icon-xs icon-circle icon-darkest-filled" href="https://www.facebook.com/jorge.fernando.1912"></a></li>
                         
                        </ul>
                      </div>
                    </div>
                  </div>
                  <p class="offset-xl-top-0 text-muted">Jorge ira ensiar como marcar corretamente um adversário evitando assim  cometer faltas.</p>
                </div>
                <div class="col-md-6 col-xl-3 offset-top-66 offset-xl-top-0">
                  
                  <div class="box-member"><img class="img-fluid" src="images/iago.jpg" alt=""/>
                    <h5 class="font-weight-bold offset-top-20"><a href="TreinadorI.php">Iago Rodrigues</a> <small class="text-danger">Passes</small>
                    </h5>
                    <div class="box-member-caption">
                      <div class="box-member-caption-inner">
                        <ul class="list-inline list-inline-xs">
                          <li class="list-inline-item"><a class="novi-icon icon fa fa-facebook icon-xs icon-circle icon-darkest-filled" href="https://www.facebook.com/iago.rodrigues.1848"></a></li>
                          
                        </ul>
                      </div>
                    </div>
                  </div>
                  <p class="offset-xl-top-0 text-muted">Iago mostrará como é impotante saber passar a bola no momento certo sem cometer erros.</p>
                </div>
                <div class="col-md-6 col-xl-3 offset-top-66 offset-xl-top-0">
            </div>
          </div>
