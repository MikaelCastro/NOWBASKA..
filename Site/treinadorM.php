        ...
        <div class="container">
          <div class="row justify-content-sm-center">
            <div class="col-sm-10 col-md-5">
              ...
              <div class="member-block-type-5 inset-lg-right-20"><img class="img-fluid mx-auto d-block" src="images/mikaelg.jpg" width="437" height="437" alt=""/>
                <div class="member-block-body"><a class="btn btn-block btn-danger" href="Contato.php">Faça sua pergunta</a>
                  <div class="offset-top-34">
                    <ul class="list-inline list-inline-xs">
                      <li class="list-inline-item"><a class="novi-icon icon icon-xxs icon-circle icon-darkest-filled fa-facebook" href="https://www.facebook.com/mikael.castro.35/"></a></li>
                      
                    </ul>
                  </div>
                  <address class="contact-info offset-top-20 offset-md-top-34">
                    <ul class="list-unstyled p">
                      <li><span class="novi-icon icon icon-xxs text-middle text-dark mdi mdi-phone"></span><a class="p big text-middle d-inline-block offset-top-0" href="tel:1-800-1234-567">(11) 99703-9874</a></li>
                      <li><span class="novi-icon icon icon-xxs text-middle text-dark mdi mdi-email-open"></span><a class="p big text-middle d-inline-block offset-top-0 text-picton-blue" href="mikaelcastrosouza@hotmail.com">mikaelcastrosouza@hotmail.com</a></li>
                    </ul>
                  </address>
                </div>
              </div>
            ...
            <div class="col-sm-10 col-md-7 text-md-left">
              <div>
                <h1 class="text-darker">Mikael de Castro Souza</h1>
              </div>
              <p class="text-muted offset-top-4">Treinador de Arremessos</p>
              <hr class="divider bg-red hr-md-left-0">
              <p class="offset-top-50 text-left"> Mikael Castro possui habilidades quando se trata de arremessar a bola em direção a cesta, joga como ala em seu time.</p>
              <div class="offset-top-30 text-center">
                <p>
                  <q class="font-italic h3 text-regular">"Quero ensinar maneiras simples dos jogadores pontuarem com cestas de longa distância."</q>
                </p>
              </div>
              <div class="offset-top-30">
                <p class="text-left">Mikael pratica o basquete a 5 anos e ja participou de competições onde junto de seu time foi campeão.</p>
              </div>
